...
static void usage(
    ...
    std::cout
        ...
        << "  "
        << prog
        << " 128 4096 4096 --kernel tcv7_m128_n64_k16_w64x32_fp\n";
}
...
static int run_fp32(
    ...
    std::cout
        << "Family: FP32 SIMT (V5-compatible, retained in V7)\n";
...
static int run_fp16(
    ...
    std::cout
        << "Family: FP16 Tensor Core V7 / FP32 accumulate\n";
